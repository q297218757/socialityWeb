package czc.recruit.controller;
...
import czc.recruit.pojo.Enterprise;
import czc.recruit.service.EnterpriseService;
...
public class EnterpriseController {
	...
	public Result findByIsHot(String isHot){
		List<Enterprise> enterpriseList = enterpriseService.findByIsHot(isHot);
